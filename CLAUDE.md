...
Praecepta is a composable Python framework for building DDD/ES (Domain-Driven Design / Event Sourcing) multi-tenant applications. It is a uv workspaces monorepo containing 11 packages, currently in pre-alpha (v2.1.1) with stub scaffolding in place.
